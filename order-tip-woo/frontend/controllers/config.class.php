...
class WOO_Order_Tip_Config {
    ...
    **/
    function scripts() {
        ...
        wp_register_script( 'woo-order-tip-js', WOOOTIPURL . 'assets/build/front.js', array('jquery'), WOOTIPVER, true );
        wp_localize_script( 'woo-order-tip-js', 'wootip', array(
            ...
            's'    => array(
                ...
                /* translators: 1: countdown number, 2: 'second' or 'seconds' */
                'rate_limit_msg' => esc_html__( 'Wait %1$s %2$s before changing the tip...', 'order-tip-woo' ),
                /* translators: singular form for countdown */
                'second' => esc_html__( 'second', 'order-tip-woo' ),
                /* translators: plural form for countdown */
                'seconds' => esc_html__( 'seconds', 'order-tip-woo' )
            ),
        ) );
    }
